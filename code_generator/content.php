...
function headerContent($dir = "/")
{
    echo "<!DOCTYPE html>
                ...
                <head>
                    ...
                    <title>Sistema de Derivação Semiautom&aacute;tico de Produtos e Implanta&ccedil;&atilde;o - Gerador de C&oacute;digo</title>
                ...
                <body>
                     <nav class=\"#1976d2 blue darken-2\" style=\"height: 100px\" role=\"navigation\">
                        <div class=\"nav-wrapper container\">
                          <a href=\"#\" class=\"brand-logo\" style=\"margin: 20px 0px 20px 0px;\"> <h5 style=\"font-size: 24px;\">Easy Software Product Derivation</h5></a>
                        </div>
                      </nav>
                    <div class=\"row\">";
}
...
function footerContent($dir = "/")
{
    echo "<!-- end content -->
              ...
              <script type=\"text/javascript\" src=\"{$dir}lib/jquery3.3.1.min.js\"></script>
