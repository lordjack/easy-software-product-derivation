    ...
    public static function parse($file, $theme)
    {
        switch ($theme) {
            case 'theme1':
                ...
                $menu = \Adianti\Widget\Menu\TMenuBar::newFromXML('menu.xml', $callback);
                $menu->show();
            ...
            default:
                ...
                $callback = array('SystemPermission', 'checkPermission');
                $xml = new \SimpleXMLElement(file_get_contents('menu.xml'));
                $menu = new \Adianti\Widget\Menu\TMenu($xml, $callback, 1, 'ml-menu', 'x', 'menu-toggle waves-effect waves-block');
